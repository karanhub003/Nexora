    ...
    <div className="heroContentContainer flex flex-col space-y-4   ">
      ...
      <div className="headingContainer flex flex-col space-y-1 ">
        <div className="headingWrapper">
          <h1 className="text-[52px] font-bold font-display leading-14">Products</h1>
          <h1 className="text-[52px] font-bold font-display leading-14">for a Better</h1>
          <h1 className="text-[52px] font-bold font-display leading-14">Tomorrow</h1>
        </div>
        <div className="subHeadingContainer w-95">
          <p className="text-[16px] font-light font-body text=[#3B3935]">
